...
class CronJob extends \Daycry\CronJob\Config\CronJob
{
    ...
    */
    ...
    {
        $schedule->call(function() { \App\Controllers\FileController::file_process(); } )->everyFiveMinutes()->named('file_process');

        $schedule->call(function () {
            \App\Controllers\FileSendToPeruriController::send_document();
        })->everyMinute()->named('send_document');
