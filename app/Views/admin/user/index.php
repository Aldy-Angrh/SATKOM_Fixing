            ...
            <div class="modal-body" id="modal-body">
                <form method="post" id="form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="model_name" placeholder="John Doe">
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" class="form-control" name="email" id="model_email" placeholder="john.doe@mail.com">
                    </div>
                    <div class="form-group">
                        <label for="phone_number">No HP</label>
                        <input type="text" class="form-control" name="phone_number" id="model_phone_number" placeholder="62856942093812">
                    </div>
                    <div class="form-group">
                        <label for="username">Username</label>
                        <input type="text" class="form-control" name="username" id="model_username" placeholder="john.doe">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="role_id" id="model_role_id" class="form-control">
